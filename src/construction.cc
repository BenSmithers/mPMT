...
G4LogicalVolume *myDetectorConstruction::ConstructPMT()
{
  ...
  G4Material *poron = new G4Material("PolyurethaneFoam", density, 4);
  ...
  */
  ...
  //  G4double COATEDTHICKNESS_glasscath_KCsCb = 30.0*nm;
  ...
  if (pmtsurftype != 0)
  {
    ...
    else if (cathodepara == 1)
    {
      ...
      // myST2->AddProperty("COATEDRINDEX", ENERGY_COATED_WAV, COATEDRINDEX_glasscath_KCsCb, NUMWAV, true);
      // myST2->AddProperty("COATEDRINDEXIM", ENERGY_COATED_WAV, COATEDRINDEXIM_glasscath_KCsCb, NUMWAV, true);
    ...
    else if (cathodepara == 2)
    {
      ...
      // myST2->AddProperty("COATEDRINDEX", ENERGY_COATED_WAV, COATEDRINDEX_glasscath_RbCsCb, NUMWAV, true);
      // myST2->AddProperty("COATEDRINDEXIM", ENERGY_COATED_WAV, COATEDRINDEXIM_glasscath_RbCsCb, NUMWAV, true);
